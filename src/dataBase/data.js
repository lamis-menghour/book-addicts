const books = [
  ...
  },
  {
    ...
    language: "English",
    category: "Finance",
    dscrp: "تحدث الكتاب عن تجارب حقيقية لأشخاص تعرضوا للإساءات من قبل آبائهم، وكيف أثرت هذه الإساءات على حياتهم. ويقدم الكتاب أيضاً نصائح وتوجيهات للأشخاص الذين تعرضوا للإساءات من قبل آبائهم، حتى يتمكنوا من التعافي منها وبناء حياة صحية وناجحة.",
  },
  {
    id: 7,
    title: "اكستاسي",
